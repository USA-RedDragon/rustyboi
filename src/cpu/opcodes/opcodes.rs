...
pub const OPCODES: [Opcode; 256] = [
    ...
    Opcode { name: "INC B", length: 1, cycles: 4, execute: nop }, // 0x04
    Opcode { name: "DEC B", length: 1, cycles: 4, execute: nop }, // 0x05
    Opcode { name: "LD B,n", length: 1, cycles: 4, execute: nop }, // 0x06
    ...
    Opcode { name: "INC C", length: 1, cycles: 4, execute: nop }, // 0x0C
    Opcode { name: "DEC C", length: 1, cycles: 4, execute: nop }, // 0x0D
    Opcode { name: "LD C,n", length: 1, cycles: 4, execute: nop }, // 0x0E
