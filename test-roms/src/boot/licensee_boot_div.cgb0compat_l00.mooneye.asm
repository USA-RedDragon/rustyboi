; licensee_boot_div.cgb0compat_l00.mooneye — the CGB boot ROM's licensee
...
; `rgbfix` from the `cgb0compat_l00` model token in the Makefile, so the
...
Start:
    ...
    licensee_boot_div_test $28, $00, $00, $00
