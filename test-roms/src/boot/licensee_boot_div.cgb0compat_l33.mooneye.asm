; licensee_boot_div.cgb0compat_l33.mooneye — the CGB boot ROM's licensee
; branch, observed as post-boot DIV on CPU CGB0 silicon.
;
; A DMG-compatibility cartridge (non-Nintendo header) booted on CPU CGB0. The
...
;
; Expected DIV $28, derived by executing cgb0_boot.bin against this exact
...
; `rgbfix` from the `cgb0compat_l33` model token in the Makefile, so the
...
Start:
    ...
    licensee_boot_div_test $28, $33, $00, $00
