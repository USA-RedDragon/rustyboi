; licensee_boot_div.cgb0compat_l01.mooneye — the CGB boot ROM's licensee
...
; `rgbfix` from the `cgb0compat_l01` model token in the Makefile, so the
...
Start:
    ...
    licensee_boot_div_test $39, $01, $00, $00
